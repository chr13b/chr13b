...
| **[LLM Post-Training Recipe Lab](https://github.com/chr13b/llm-post-training-recipe-lab)** | An autonomous, git-ratcheted loop that searches SFT/DPO post-training recipes for small instruct models | Reproducible evals and honest negative results · **SFT · DPO** |
